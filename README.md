...
app/                    --> all of the source files for the application
  ...
  favorites/                --> the favorite view template and logic
    favorite_view.html            --> the partial template
    favorite_view.js              --> the controller logic
    favorite_view_test.js         --> tests of the controller
